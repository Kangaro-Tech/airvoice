              ...
              {staffBalances.map(bal => {
                ...
                return (
                  <tr key={bal.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-4 py-3 text-center font-medium" style={{ color: 'var(--text-primary)' }}>{bal.allotted_days}</td>
                    <td className="px-4 py-3 text-center font-medium" style={{ color: 'var(--text-primary)' }}>{bal.used_days}</td>
